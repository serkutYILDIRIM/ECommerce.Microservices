        ...
        string serviceVersion)
    {
        ...
        builder.Host.UseSerilog((hostingContext, loggerConfiguration) =>
        {
            ...
            loggerConfiguration
                ...
                // Remove the ReadFrom.Services line
                .Enrich.FromLogContext()
                .Enrich.WithProperty("ServiceName", serviceName)
                .Enrich.WithProperty("ServiceVersion", serviceVersion)
                .Enrich.WithProperty("Environment", builder.Environment.EnvironmentName)
            ...
            // Apply standard minimum level overrides
            ConfigureMinimumLevelOverrides(loggerConfiguration, hostingContext.Configuration);

            // Apply advanced filtering
            loggerConfiguration.WithFiltering(hostingContext.Configuration);
